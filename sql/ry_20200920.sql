...
-- ----------------------------
-- Table structure for abit_apk
-- ----------------------------
DROP TABLE IF EXISTS `abit_apk`;
CREATE TABLE `abit_apk`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '当前apk的唯一id',
  `app_id` int(11) NULL DEFAULT NULL COMMENT '外键 关联abit_app的唯app_id',
  `android_download_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'android下载路径',
  `status` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '0 表示禁用\r\n1 表示可用\r\n2 表示删除',
  `version` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '版本号',
  `build` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '构建版本号',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '本次更新内容',
  `ios_down_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'ios的appstore URL配置',
  `user_id` int(11) NULL DEFAULT NULL COMMENT '本次包是由谁上传',
  `update_status` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '更新状态\r\n0 不更新\r\n1 不强制更新\r\n2 强制更新',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `download_count` int(255) NULL DEFAULT NULL COMMENT '下载次数',
  `app_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'app名称',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  `apk_size` bigint(11) NULL DEFAULT NULL COMMENT '包大小',
...
-- ----------------------------
-- Table structure for abit_app
-- ----------------------------
DROP TABLE IF EXISTS `abit_app`;
CREATE TABLE `abit_app`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '数据唯一id',
  `app_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'app_id',
  `app_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'app名称',
  `create_time` datetime(0) NOT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `user_id` bigint(11) NOT NULL COMMENT '创建者',
  `status` int(255) NOT NULL COMMENT '0 表示禁用\r\n1 表示可用\r\n2 表示删除',
...
-- ----------------------------
-- Table structure for abit_log
-- ----------------------------
DROP TABLE IF EXISTS `abit_log`;
CREATE TABLE `abit_log`  (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '记录的id',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '标题',
  `content` mediumtext CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '上报的内容',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '记录事件',
  `extra` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '帮助查询的额外字段',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;